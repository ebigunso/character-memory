...
pub use crate::api::types::{
    ...
    RetrievalTelemetry, RetrievalTrace, RetrieveOutcome, SceneReference, SceneReferenceResolution,
    SceneReferenceResult, SectionAssignment, SectionAssignmentReason, SectionCueScoreSource,
    ...
    SourceProvenanceReference, SourceScene, SourceSceneUnavailableReason, SourceSpan,
