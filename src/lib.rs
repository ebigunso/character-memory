...
pub use crate::api::types::{
    ...
    CorrectionLifecyclePolicy, CorrectionTarget, DerivedMemoryCandidate, DerivedMemoryDraft,
    ...
    SectionAssignmentReason, SectionPressureSummary, SectionScoreComponents,
    SectionVectorScoreSource, SelectivityCountScope, SelectivityDecision, SelectivityTelemetry,
