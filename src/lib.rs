...
pub use crate::api::types::{
    ...
    LastInteraction, LifecycleFilterDecision, LifecycleFilterReason, LifecycleMutationDiagnostics,
    ...
    SceneReferenceResult, SectionAssignment, SectionAssignmentReason, SectionScoreComponents,
    SelectivityCountScope, SelectivityDecision, SelectivityTrace, SourceObjectCorrectionTarget,
