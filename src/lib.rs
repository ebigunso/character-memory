...
pub use crate::api::types::{
    ...
    GraphExpansionTrace, GraphRelationTrace, IncludedDerivedMemory, LifecycleFilterAction,
    ...
    MemoryCandidate, MemoryLinkCandidate, MemoryLinkDraft, MemoryObjectDraft,
    MemoryThreadCandidate, MemoryThreadDraft, ObservationCandidate, ObservationDraft,
    PrepareOptions, RationaleCategory, RememberDiagnostic, RememberDiagnosticCode,
...
pub use crate::domain::{
    ...
    SceneActivity, SceneParticipant, SceneSetting, SourceReferenceKind, ThreadStatus,
