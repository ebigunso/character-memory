...
pub use crate::api::types::{
    ...
    GraphRootSource, IncludedDerivedMemory, LastInteraction, LifecycleFilterDecision,
    LifecycleFilterReason, LifecycleMutationDiagnostics, LifecycleMutationOutcome,
    LifecycleMutationTrace, LifecycleMutationWarning, LifecycleMutationWarningReason,
    LifecycleOmissionSummary, LifecycleTargetRef, LinkOutcome, MemoryCandidate,
    MemoryLinkCandidate, MemoryLinkDraft, MemoryObjectDraft, MemoryScenes, MemoryThreadCandidate,
    MemoryThreadDraft, ObservationCandidate, ObservationDraft, PrepareOptions, RememberDiagnostic,
    ...
    RetrievalTelemetry, RetrievalTrace, RetrieveOutcome, SceneCueSearchTrace, SceneReference,
    SceneReferenceResolution, SceneReferenceResult, SectionAssignment, SectionAssignmentReason,
    ...
    StatsUpdateStatus, SupersededByEvidence, SuppressionPolicy, TimeRange, VectorCandidateTrace,
