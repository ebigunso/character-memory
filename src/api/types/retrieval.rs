...
///
/// Trace roots are a subset of returned expansion objects: nodes admitted at max
/// depth are returned but are not expanded and therefore emit no utilization rows.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
