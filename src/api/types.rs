...
pub use retrieval::{
    ...
    RetrievalRationale, RetrievalTelemetry, RetrievalTrace, RetrieveOutcome, ScenePart,
    SceneReference, SceneReferenceResolution, SceneReferenceTrace, SectionAssignment,
