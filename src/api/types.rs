...
pub use retrieval::{
    ...
    LifecycleFilterReason, LifecycleOmissionSummary, MemoryScenes, RetrievalCandidateLimits,
    RetrievalContext, RetrievalCueFloors, RetrievalGraphLimits, RetrievalLifecyclePolicy,
    RetrievalRationale, RetrievalTelemetry, RetrievalTrace, RetrieveOutcome, SceneCueSearchTrace,
    SceneReference, SceneReferenceResolution, SceneReferenceResult, SectionAssignment,
    SectionAssignmentReason, SectionPressureSummary, SectionScoreComponents, SelectivityCountScope,
    SelectivityDecision, SelectivityTelemetry, SelectivityTrace, SourceScene,
    SourceSceneUnavailableReason, StaleCandidateOmission, StaleCandidateOmissionSummary,
