...
pub use retrieval::{
    ...
    LifecycleFilterReason, LifecycleOmissionSummary, MemoryScenes, RationaleCategory,
    RetrievalCandidateLimits, RetrievalContext, RetrievalGraphLimits, RetrievalLifecyclePolicy,
    RetrievalRationale, RetrievalTelemetry, RetrievalTrace, RetrieveOutcome, SceneReference,
    ...
    StaleCandidateReason, VectorCandidateTrace, VectorRecallCompleteness,
};
pub use write_plan::{
