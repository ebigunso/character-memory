...
pub use retrieval::{
    ...
    CueFloorStage, CueKind, FanoutUtilizationTrace, GraphExpansionOutcome, GraphExpansionTelemetry,
    GraphExpansionTrace, GraphRelationTrace, GraphRootSource, IncludedDerivedMemory,
    LastInteraction, LifecycleFilterDecision, LifecycleFilterReason, LifecycleOmissionSummary,
    MemoryScenes, RetrievalCandidateLimits, RetrievalContext, RetrievalCueFloors,
    ...
    SelectivityCountScope, SelectivityDecision, SelectivityTrace, SourceScene,
