...
- Embedded persistent Oxigraph is the validated default graph store; configuration accepts a local `OXIGRAPH_PATH` and rejects unsupported graph modes (ADR-I-0021).
