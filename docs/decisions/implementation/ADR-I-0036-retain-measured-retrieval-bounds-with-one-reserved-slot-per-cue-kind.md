...
- The public companion evaluation repository, `CharacterMemoryEvals`, retains the scene reminder calibration and its measurements; its tooling is a development aid, not core library functionality.
